...
public class HeaderViewPager extends LinearLayout {
    ...
    private final int mMinimumVelocity;   //允许执行一个fling手势动作的最小速度值
    private final int mMaximumVelocity;   //允许执行一个fling手势动作的最大速度值
    private final int sysVersion;         //当前sdk版本，用于判断api版本
    private View mHeadView;         //需要被滑出的头部
    private int maxY = 0;           //最大滑出的距离，等于 mHeadHeight
    private final int minY = 0;           //最小的距离， 头部在最顶部
    ...
    private final HeaderScrollHelper mScrollable;
