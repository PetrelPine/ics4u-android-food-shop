...
public class ShopHomeActivity extends BaseActivity {
    ...
    private final String[] titles = {"Grid", "Linear"};
    private final List<String> mDataList = Arrays.asList(titles);
    ...
    protected void initView() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                indicator.setMode(LinePagerIndicator.MODE_WRAP_CONTENT); // length of the underline is the same as the font
